...
/**
 * Table — POS тизмелери үчүн, sticky header жана touch-friendly
 */
const Table = React.forwardRef<HTMLTableElement, React.HTMLAttributes<HTMLTableElement>>(
  ({ className, ...props }, ref) => (
    <div className="relative w-full overflow-auto scrollbar-thin rounded-md border">
...
>(({ className, ...props }, ref) => (
  <th
    ...
    className={cn(
      ...
      '[&:has([role=checkbox])]:pr-0 sticky top-0 bg-muted/80 backdrop-blur-sm z-10',
      className
    )}
    {...props}
  />
